...
player = new MediaPlayer(document.getElementById('player-1'));
player.render({
	// seekControls: false,
	// volumeControls: false
});
player = new MediaPlayer(document.getElementById('player-2'));
player.render({})
player = new MediaPlayer(document.getElementById('player-3'));
player.render({})
player = new MediaPlayer(document.getElementById('player-4'));
player.render({})